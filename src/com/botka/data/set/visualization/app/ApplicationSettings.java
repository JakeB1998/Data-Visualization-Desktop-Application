...
/**
 * 
 * Application Settings that is host to all settings' classes.
 *
 * @author Jake Botka
 *
 */
public class ApplicationSettings implements Serializable {
	...
	/**
	 * For when programmers add more setting implementationss This gets all settings
	 * downcasted to Type T.
	 * 
	 * @param classType
	 * @return
	 */
	...
	/**
	 * For when programmers add more setting implementations. This gets all settings
	 * downcasted to Type T.
	 * 
	 * @param classType
